      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl mx-4 h-[600px] flex flex-col border border-gray-700"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="p-4 border-b border-gray-700 flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-100">
                Learn More: <span className="text-blue-400">{nodeTitle}</span>
              </h2>
              <button
                onClick={onClose}
                ...
                >
                  <div
                    className={`max-w-[80%] p-3 rounded-lg ${
                      message.sender === "user"
                        ? "bg-blue-600 text-gray-100 rounded-tr-none"
            ...
            <div className="p-4 border-t border-gray-700">
              <div className="flex items-center space-x-2">
                <textarea
                  ...
                  className="flex-1 p-3 bg-gray-800 text-gray-100 border border-gray-700 rounded-lg 
